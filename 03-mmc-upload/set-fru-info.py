...
parser.add_argument("--csv-in", type=str, help="CSV with informations of the AFCv4 boards", required=True)
parser.add_argument("--rack_number", type=int, help="Number of the rack", required=True)
